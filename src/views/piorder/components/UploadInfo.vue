...
<template>
  <el-card v-loading="loading" shadow="never" class="search-wrapper">
    ...
    <el-descriptions :column="3" border>
      ...
      <el-descriptions-item label="PI號">---</el-descriptions-item>
      <el-descriptions-item label="發貨計劃號">---</el-descriptions-item>
      <el-descriptions-item label="訂單總數量">{{ infoData.order_sum }}</el-descriptions-item>
      <el-descriptions-item label="PI數量">{{ infoData.pi_total_number }}</el-descriptions-item>
      <el-descriptions-item label="PI已發貨數">---</el-descriptions-item>
      <el-descriptions-item label="PI未發貨數">---</el-descriptions-item>
      <el-descriptions-item label="PI總金額">{{ infoData.pi_total_prices }}</el-descriptions-item>
      ...
      <el-descriptions-item label="訂單總金額">{{ infoData.order_total_prices }}</el-descriptions-item>
