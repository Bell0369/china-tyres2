...
import { getFactoryPrimitivePriceListApi, AddFactoryPrimitivePriceApi, AffirmFactoryReceivableApi } from "@/api/order"
...
const submitForm = (formEl) => {
  ...
  formEl.validate((valid, fields) => {
    if (valid) {
      AddFactoryPrimitivePriceApi(prepayForm).then(() => {
...
const getTableData = () => {
  loading.value = true
  getFactoryPrimitivePriceListApi({
    factory_id: itemId,
    factory_accrued_id: ids
  })
    .then(({ data }) => {
