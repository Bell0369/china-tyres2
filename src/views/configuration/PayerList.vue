...
import { getPayerListApi, addPayerApi, updatePayerStatusApi, deletePayerApi } from "@/api/selects"
...
const rules = reactive({
  name: [{ required: true, message: "請輸入付款方名稱", trigger: "blur" }]
})
...
<template>
  <div class="app-container">
    <el-card shadow="never" class="search-wrapper">
      <el-input v-model="searchData.keyword" placeholder="輸入付款方名稱" style="width: 300px; margin-right: 15px" />
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="pb5">
        <div class="flex justify-between mb5">
          <el-text tag="b" size="large">付款方管理</el-text>
          <div>
    ...
    <el-dialog v-model="dialogVisible" :title="formDataTitle" width="40%" destroy-on-close>
      <el-form ref="formRef" :model="formData" :rules="rules" hide-required-asterisk>
        <el-form-item label="付款方名稱" prop="name">
